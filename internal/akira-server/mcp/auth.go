...
// чтобы LLM мог управлять ими — читать файлы, писать файлы, искать
// по шаблонам и исполнять команды.
//
...
// exec, read, edit, write, glob и list; resources.go — ресурс
// akira://machines; server.go — сборка HTTP-хендлера.
package akiramcp
