...
const (
	DBService_AddUser_FullMethodName = "/github.com.PinguinAdvokat.akira_mcp.db.DBService/AddUser"
	DBService_GetUser_FullMethodName = "/github.com.PinguinAdvokat.akira_mcp.db.DBService/GetUser"
)
...
func (c *dBServiceClient) AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, DBService_AddUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) GetUser(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (UnimplementedDBServiceServer) AddUser(context.Context, *User) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddUser not implemented")
}
func (UnimplementedDBServiceServer) GetUser(context.Context, *UserID) (*User, error) {
...
var DBService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.PinguinAdvokat.akira_mcp.db.DBService",
